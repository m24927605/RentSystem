...
module.exports = (sequelize, DataTypes) => {
  const PayFlow = sequelize.define('PayFlow', {
    ...
    PowerQty: { type: DataTypes.FLOAT, allowNull: true, comment: '當前電力度數', field: 'PowerQty' },
    UsedPowerQty: { type: DataTypes.FLOAT, allowNull: true, comment: '使用電力度數', field: 'UsedPowerQty' },
